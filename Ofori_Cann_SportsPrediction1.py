  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/kcann340/FIFARegression_Submission/blob/main/Ofori_Cann_SportsPrediction1.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "_JnNUZ9VolRo",
        "outputId": "1620787c-c64d-4988-9ae6-8a337235beaa"
      },
      "execution_count": 41,
      "outputs": [
        {
          ...
          "name": "stderr",
          "text": [
            "<ipython-input-41-c4c89de66134>:15: DtypeWarning: Columns (108) have mixed types. Specify dtype option on import or set low_memory=False.\n",
            "  playertrain_df = pd.read_csv(\"/content/male_players (legacy).csv\") # For training\n",
            "<ipython-input-41-c4c89de66134>:16: DtypeWarning: Columns (25,108) have mixed types. Specify dtype option on import or set low_memory=False.\n",
            "  playertest_df = pd.read_csv(\"/content/players_22 (1).csv\") # For testing\n"
          ]
        },
        {
          ...
          "text": [
            ...
            "RangeIndex: 41254 entries, 0 to 41253\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "f38QuZ3ColZt",
        "outputId": "a20f0b23-cb65-4ef9-cdc3-4884bc8ce215"
      },
      "execution_count": null,
      "outputs": [
        {
